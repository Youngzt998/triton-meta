        ...
        with T.sblock("root"):
            ...
            with T.sblock("tilelang_root"):
                ...
                if T.tl_shuffle_elect(256):
                    T.ptx_arrive_barrier_expect_tx(mbarrier_1[4], T.int64(4096))
                ...
                if tx < 128:
                    for k in range(T.min(2, bx - 3)):
                        ...
                        if T.tl_shuffle_elect(128):
                            T.ptx_arrive_barrier_expect_tx(mbarrier_1[0], T.int64(4096))
                        ...
                        if T.tl_shuffle_elect(128):
                            T.ptx_arrive_barrier_expect_tx(mbarrier_1[1], T.int64(4096))
