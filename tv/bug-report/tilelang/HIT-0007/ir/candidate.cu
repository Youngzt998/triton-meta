  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  for (int k = 0; k < 3; ++k) {
    ...
    for (int i_4 = 0; i_4 < 8; ++i_4) {
      ...
      *(float4*)(s + (i_4 * 4)) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    }
    tl::cp_async_wait<1>();
    __syncthreads();
    {
  ...
  for (int i_14 = 0; i_14 < 8; ++i_14) {
    ...
    *(float4*)(s + (i_14 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
  }
  tl::cp_async_wait<1>();
  __syncthreads();
  {
