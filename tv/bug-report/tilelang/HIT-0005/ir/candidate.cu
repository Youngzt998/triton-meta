...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ O, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_2, broadcast_var_2);
  ...
  for (int i_4 = 0; i_4 < 4; ++i_4) {
    tl::cp_async_gs<16>((&(((half_t*)Ks)[((((((i_4 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)])), (&(K[(((i_4 * 1024) + (((int)threadIdx.x) * 8)) + 4096)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_5 = 0; i_5 < 4; ++i_5) {
    tl::cp_async_gs<16>((&(((half_t*)Vs)[((((((i_5 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)])), (&(V[(((i_5 * 1024) + (((int)threadIdx.x) * 8)) + 4096)])));
  }
  tl::cp_async_commit();
  for (int k = 0; k < (((int)blockIdx.x) + 1); ++k) {
    #pragma unroll
    for (int i_6 = 0; i_6 < 32; ++i_6) {
      s[i_6] = 0x0p+0f/*0.000000e+00*/;
    }
    tl::cp_async_wait<3>();
    __syncthreads();
    {
    ...
    for (int i_7 = 0; i_7 < 4; ++i_7) {
      tl::cp_async_gs<16>((&(((half_t*)Ks)[((((((k * 4096) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(K[((((k * 4096) + (i_7 * 1024)) + (((int)threadIdx.x) * 8)) + 8192)])));
    }
    tl::cp_async_commit();
    ...
    *(float2*)(mx + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      tl::cp_async_gs<16>((&(((half_t*)Vs)[((((((k * 4096) + (i_13 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(V[((((k * 4096) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) + 8192)])));
    }
    tl::cp_async_commit();
    #pragma unroll
  ...
  __syncthreads();
  {
    ...
    tl::increase_descriptor_offset<int>(desc_b_2, (((((int)blockIdx.x) + 1) & 1) * 8192));
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
    tl::warpgroup_arrive();
    tl::fence_proxy_async();
    #pragma unroll
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  __syncthreads();
  {
    ...
    tl::increase_descriptor_offset<int>(desc_b_3, (((((int)blockIdx.x) + 1) & 1) * 8192));
    tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(sc + 0), 16);
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    tl::warpgroup_arrive();
    #pragma unroll
  ...
  for (int i_24 = 0; i_24 < 32; ++i_24) {
    float condval;
    if ((((((((int)blockIdx.x) * 64) + ((i_24 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_24 & 1)) <= ((((((int)blockIdx.x) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_24 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  __syncthreads();
  {
    ...
    tl::increase_descriptor_offset<int>(desc_b_4, (((int)blockIdx.x) * 8192));
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
    tl::warpgroup_arrive();
    #pragma unroll
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_5, broadcast_var_5);
  ...
  for (int i_25 = 0; i_25 < 2; ++i_25) {
    mx_clear_1[i_25] = -CUDART_INF_F;
    #pragma unroll
    for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
      mx_clear_1[i_25] = max(mx_clear_1[i_25], s[((((rv_4 & 7) * 4) + (i_25 * 2)) + (rv_4 >> 3))]);
    }
    mx_clear_1[i_25] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(mx_clear_1[i_25]);
    mx[i_25] = max(mx[i_25], mx_clear_1[i_25]);
  }
  #pragma unroll
  ...
  __syncthreads();
  {
    ...
    tl::increase_descriptor_offset<int>(desc_b_5, (((int)blockIdx.x) * 8192));
    tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(sc + 0), 16);
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    tl::warpgroup_arrive();
    #pragma unroll
  ...
  for (int i_33 = 0; i_33 < 4; ++i_33) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)Os)[(((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_33 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)o[(i_33 * 8)]), ((half_t)o[((i_33 * 8) + 1)])), __pack_half2(((half_t)o[((i_33 * 8) + 2)]), ((half_t)o[((i_33 * 8) + 3)])), __pack_half2(((half_t)o[((i_33 * 8) + 4)]), ((half_t)o[((i_33 * 8) + 5)])), __pack_half2(((half_t)o[((i_33 * 8) + 6)]), ((half_t)o[((i_33 * 8) + 7)])));
  }
  __syncthreads();
