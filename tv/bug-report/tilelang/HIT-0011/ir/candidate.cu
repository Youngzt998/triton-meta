...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const half_t* __restrict__ K, __grid_constant__ const CUtensorMap O_desc, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  tl::cp_async_commit();
  for (int k = 0; k < (min(4, (((int)blockIdx.x) + 3)) - 1); ++k) {
    #pragma unroll
    for (int i_4 = 0; i_4 < 32; ++i_4) {
      float condval_1;
      if ((((((k * 64) + ((i_4 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_4 & 1)) <= (((((((int)blockIdx.x) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_4 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 126))) {
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      tl::cp_async_gs<16>((&(((half_t*)Ks)[(((((i_5 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(K[(((((((int)blockIdx.y) * 16384) + (k * 4096)) + (i_5 * 1024)) + (((int)threadIdx.x) * 8)) + 4096)])));
    }
    tl::cp_async_commit();
    ...
    *(float2*)(mx + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int i_11 = 0; i_11 < 4; ++i_11) {
      tl::cp_async_gs<16>((&(((half_t*)Vs)[(((((i_11 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(V[(((((((int)blockIdx.y) * 16384) + (k * 4096)) + (i_11 * 1024)) + (((int)threadIdx.x) * 8)) + 4096)])));
    }
    tl::cp_async_commit();
    #pragma unroll
  ...
  for (int i_14 = 0; i_14 < 32; ++i_14) {
    float condval_2;
    if ((((((min(4, (((int)blockIdx.x) + 3)) * 64) + ((i_14 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_14 & 1)) <= (((((((int)blockIdx.x) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_14 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 190))) {
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_5, broadcast_var_5);
  ...
  for (int i_23 = 0; i_23 < 4; ++i_23) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)Os)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_23 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_23 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)o[(i_23 * 8)]), ((half_t)o[((i_23 * 8) + 1)])), __pack_half2(((half_t)o[((i_23 * 8) + 2)]), ((half_t)o[((i_23 * 8) + 3)])), __pack_half2(((half_t)o[((i_23 * 8) + 4)]), ((half_t)o[((i_23 * 8) + 5)])), __pack_half2(((half_t)o[((i_23 * 8) + 6)]), ((half_t)o[((i_23 * 8) + 7)])));
  }
  __syncthreads();
