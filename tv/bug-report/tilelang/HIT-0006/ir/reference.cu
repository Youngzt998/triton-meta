...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const bfloat16_t* __restrict__ KV, __grid_constant__ const CUtensorMap Output_desc, const bfloat16_t* __restrict__ Q, const bfloat16_t* __restrict__ Sinks, const int* __restrict__ TopkIndices) {
  ...
  for (int i_i = 0; i_i < 2; ++i_i) {
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      ...
      scores_max_clear[i_6] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_6], (&(((float*)workspace_5)[0])));
    ...
    for (int i_10 = 0; i_10 < 2; ++i_10) {
      ...
      scores_sum[i_10] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_10], (&(((float*)workspace_3)[0])));
  ...
  *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
  ...
  for (int i_17 = 0; i_17 < 2; ++i_17) {
    ...
    scores_max_clear_1[i_17] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_17], (&(((float*)workspace_1)[0])));
  ...
  for (int i_21 = 0; i_21 < 2; ++i_21) {
    ...
    scores_sum[i_21] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_21], (&(((float*)workspace)[0])));
  ...
  *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
  ...
  for (int i_27 = 0; i_27 < 2; ++i_27) {
    ...
    scores_max_clear_2[i_27] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_27], (&(((float*)workspace_2)[0])));
