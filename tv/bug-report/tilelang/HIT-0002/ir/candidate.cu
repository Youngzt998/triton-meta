...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ O, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_2, broadcast_var_2);
  ...
  for (int k = 0; k < 2; ++k) {
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      ...
      *(float4*)(s + (i_6 * 4)) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
    }
    tl::cp_async_wait<3>();
    __syncthreads();
    {
  ...
  for (int i_16 = 0; i_16 < 8; ++i_16) {
    ...
    *(float4*)(s + (i_16 * 4)) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
  }
  tl::cp_async_wait<3>();
  __syncthreads();
  {
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_6, broadcast_var_6);
  #pragma unroll
  ...
  for (int i_24 = 0; i_24 < 8; ++i_24) {
    ...
    *(float4*)(s + (i_24 * 4)) = make_float4(broadcast_var_7, broadcast_var_7, broadcast_var_7, broadcast_var_7);
  }
  tl::cp_async_wait<1>();
  __syncthreads();
  {
  ...
  *(float2*)(mx + 0) = make_float2(broadcast_var_8, broadcast_var_8);
  #pragma unroll
