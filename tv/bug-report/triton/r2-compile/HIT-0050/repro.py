#!/usr/bin/env python
"""Reproduce HIT-0050 — crash-python.
...
Expected: the compile below fails with
    ...
    PTXASError@compiler.py:630:Repro command: ptxas -lineinfo -suppress-debug-info --fmad=false -v --regAllocOptLevel=N --gpu-name=sm_Na tmpvNlNqkqN.ptx -o tmpvNlNq
"""
import json, os, sys
...
ARCH = 90
SHAPE = json.loads(r"""{"ptr_off": {"in_ptr0": 4, "out_ptr0": 0}, "ptr_ty": {"in_ptr0": "*fp32", "out_ptr0": "*fp32"}, "scalars": {"xnumel": 32, "r0_numel": 112}, "consts": {"XBLOCK": 32}, "dtype_swapped": false}""")
CONFIG = json.loads(r"""{"num_warps": 1, "num_stages": 3, "num_ctas": 1, "maxnreg": 128, "default_dot_input_precision": "tf32", "launch_cooperative_grid": false, "launch_pdl": false, "sanitize_overflow": false, "enable_fp_fusion": false}""")
